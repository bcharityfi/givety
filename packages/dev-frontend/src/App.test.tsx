...
import { Decimal, GUSD_MINIMUM_NET_DEBT, Trove } from "givety-lib-base";

import App from "./App";

const params = { depositCollateral: Decimal.from(20), borrowGUSD: GUSD_MINIMUM_NET_DEBT };
...
test("there's no smoke", async () => {
  ...
  expect(await findByText(/you can borrow gusd by opening a trove/i)).toBeInTheDocument();
