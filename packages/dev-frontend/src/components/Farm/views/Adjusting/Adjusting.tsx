...
import { Decimal, Difference, GivetyStoreState } from "givety-lib-base";
...
export const Adjusting: React.FC = () => {
  ...
  const maximumAmount = liquidityMiningStake.add(givTokenBalance);
  ...
  const nextTotalStakedGivTokens = isDirty
    ? totalStakedGivTokens.sub(liquidityMiningStake).add(amount)
    : totalStakedGivTokens;

  const originalPoolShare = liquidityMiningStake.mulDiv(100, totalStakedGivTokens);
