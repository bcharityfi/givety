...
const liquidatableInRecoveryMode = (
  ...
  if (collateralRatio.gte(MINIMUM_COLLATERAL_RATIO) && collateralRatio.lt(totalCollateralRatio)) {
    return [
      trove.debt.lte(gusdInStabilityPool),
      "There's not enough GUSD in the Stability pool to cover the debt"
    ] as const;
  } else {
...
export const RiskyTroves: React.FC<RiskyTrovesProps> = ({ pageSize }) => {
  ...
  }, [givety, clampedPage, pageSize, reload]);
            ...
            <thead>
              <tr>
                ...
                <th>
                  ...
                  <Box sx={{ fontSize: [0, 1], fontWeight: "body", opacity: 0.5 }}>GIVE</Box>
                </th>
                <th>
                  Debt
                    ...
                    <tr key={trove.ownerAddress}>
                      ...
                      <td>
                        <Transaction
                          ...
                          send={givety.send.liquidate.bind(givety.send, trove.ownerAddress)}
                        >
