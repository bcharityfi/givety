...
import { GivetyStoreState, UserTroveStatus } from "givety-lib-base";
...
const select = ({ trove: { status } }: GivetyStoreState) => status;

export const TroveViewProvider: React.FC = props => {
  const { children } = props;
  const troveStatus = useGivetySelector(select);
