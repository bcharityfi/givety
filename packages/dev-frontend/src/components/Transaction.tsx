...
import { EthersTransactionOverrides, EthersTransactionCancelledError } from "@givety/lib-ethers";
import { SentGivetyTransaction, GivetyReceipt } from "givety-lib-base";
...
type SentTransaction = SentGivetyTransaction<
  TransactionResponse,
  GivetyReceipt<TransactionReceipt>
>;
