...
import { GivetyStoreState, StabilityDeposit } from "givety-lib-base";
...
const select = ({ stabilityDeposit }: GivetyStoreState): StabilityDeposit => stabilityDeposit;

export const StabilityViewProvider: React.FC = props => {
  const { children } = props;
  const stabilityDeposit = useGivetySelector(select);
