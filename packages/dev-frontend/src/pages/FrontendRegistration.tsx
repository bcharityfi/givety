...
const FrontendRegistrationAction: React.FC<FrontendRegistrationActionProps> = ({ kickbackRate }) => {
  ...
  return myTransactionState.type === "waitingForApproval" ? (
    ...
    <Transaction id={myTransactionId} send={givety.registerFrontend.bind(givety, kickbackRate)}>
    ...
    <>
      ...
      >
        ...
        <Paragraph sx={{ fontSize: 1, mt: 3 }}>
          ...
          <b>{cut.mul(100).toString()}%</b> of the GVTY rewards earned through this frontend.
        </Paragraph>
