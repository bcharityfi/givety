...
import { BatchedWebSocketAugmentedWeb3Provider } from "givety-providers";
import { GivetyProvider } from "./hooks/GivetyContext";
...
import { GivetyFrontend } from "./GivetyFrontend";
...
const UnsupportedMainnetFallback: React.FC = () => (
  ...
  >
    ...
    <Paragraph>
      If you'd like to use the Givety Protocol on mainnet, please pick a frontend{" "}
      <Link href="https://www.givety.org/frontend">
...
const App = () => {
  ...
  const unsupportedNetworkFallback = (chainId: number) => (
    ...
    >
      <Heading sx={{ mb: 3 }}>
        <Icon name="exclamation-triangle" /> Givety is not yet deployed to{" "}
        {chainId === 1 ? "mainnet" : "this network"}.
      </Heading>
      Please switch to Ropsten, Rinkeby, Kovan, Görli or Stardust.
    </Flex>
  );
