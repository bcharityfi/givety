...
import { _GivetyContracts, _TypedGivetyContract } from "./contracts";

type ContractLookup = {
  [name: string]: _TypedGivetyContract;
};
...
export const logsToString = (receipt: TransactionReceipt, contracts: _GivetyContracts): string => {
