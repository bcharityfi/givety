...
import CommunityIssuance from "../../contracts/artifacts/contracts/GVTY/CommunityIssuance.sol/CommunityIssuance.json";
...
import LockupContractFactory from "../../contracts/artifacts/contracts/GVTY/LockupContractFactory.sol/LockupContractFactory.json";
import GUSDToken from "../../contracts/artifacts/contracts/GUSDToken.sol/GUSDToken.json";
import GVTYStaking from "../../contracts/artifacts/contracts/GVTY/GVTYStaking.sol/GVTYStaking.json";
import GVTYToken from "../../contracts/artifacts/contracts/GVTY/GVTYToken.sol/GVTYToken.json";
...
import Givpool from "../../contracts/artifacts/contracts/LPRewards/Givpool.sol/Givpool.json";
...
const declareInterface = ({
  ...
  [
    ...
    `  extends _TypedGivetyContract<${contractName}Calls, ${contractName}Transactions> {`,
