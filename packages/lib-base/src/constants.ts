 ...
 * @public
 */
export const GUSD_LIQUIDATION_RESERVE = Decimal.from(200);

/**
 * A Trove must always have at least this much debt on top of the
 * {@link GUSD_LIQUIDATION_RESERVE | liquidation reserve}.
 *
 * @remarks
 ...
 * @public
 */
export const GUSD_MINIMUM_NET_DEBT = Decimal.from(1800);
 ...
 * @public
 */
export const GUSD_MINIMUM_DEBT = GUSD_LIQUIDATION_RESERVE.add(GUSD_MINIMUM_NET_DEBT);
