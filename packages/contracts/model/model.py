...
# return the innate component of market demand for holding GVTY tokens.  Could be a function of:
...
def linear_decreasing_GIVE_price(last_price, gradient):
    return last_price - gradient

def quadratic_GIVE_price(scale, i):
    return scale*(i**2)
...
for i in range(1, 100):
    ...
    # GIVE_price = oscillating_GIVE_price(500, 10, i)
    # GIVE_price = quadratic_GIVE_price(10, i)
    # GIVE_price = linear_increasing_GIVE_price(last_GIVE_price, 100)
    # GIVE_price = linear_decreasing_GIVE_price(last_GIVE_price, 1)
