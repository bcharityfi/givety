...
//     console.log(`Testnet: Latest GIVE:USD price from aggregator: ${price_aggregatorTestnet}`);
...
//     console.log(`Testnet: Latest GIVE:USD price from deployed PriceFeed: ${price_PriceFeedTestnet}`)
...
//     console.log(`Mainnet: Latest GIVE:USD price from aggregator: ${price_aggregatorMainnet}`);
...
//     console.log(`Mainnet: Latest GIVE:USD price from deployed PriceFeed: ${price_PriceFeedMainnet}`)
