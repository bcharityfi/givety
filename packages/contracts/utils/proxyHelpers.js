...
class BorrowerOperationsProxy extends Proxy {
  ...
  async withdrawGUSD(...params) {
    return this.forwardFunction(params, 'withdrawGUSD(uint256,uint256,address,address)')
  }

  async repayGUSD(...params) {
    return this.forwardFunction(params, 'repayGUSD(uint256,address,address)')
  }
  ...
  async GUSD_GAS_COMPENSATION(...params) {
    return this.proxyFunction('GUSD_GAS_COMPENSATION', params)
  }
...
class BorrowerWrappersProxy extends Proxy {
  ...
  async transferGIVE(...params) {
    return this.forwardFunction(params, 'transferGIVE(address,uint256)')
  }
}
...
class TroveManagerProxy extends Proxy {
  ...
  async getPendingGUSDDebtReward(...params) {
    return this.proxyFunction('getPendingGUSDDebtReward', params)
  }
  ...
  async L_GIVE() {
    return this.proxyFunction('L_GIVE', [])
  }

  async L_GUSDDebt() {
    return this.proxyFunction('L_GUSDDebt', [])
  }
...
class StabilityPoolProxy extends Proxy {
  ...
  async getCompoundedGUSDDeposit(user) {
    return this.proxyFunctionWithUser('getCompoundedGUSDDeposit', user)
  }
  ...
  async getDepositorGIVEGain(user) {
    return this.proxyFunctionWithUser('getDepositorGIVEGain', user)
  }
}
...
class GVTYStakingProxy extends Proxy {
  constructor(owner, proxies, tokenScriptAddress, token) {
    super(owner, proxies, tokenScriptAddress, token)
  }
  ...
  async F_GUSD(user) {
    return this.proxyFunctionWithUser('F_GUSD', user)
  }
}
