...
const ABDKOperations = async () => {
    ...
    // Example computaton: GUSD -> Give price conversion

    // price = 200.12345678, stored as uint
    // convert 6123456700909.123456789123456789 GUSD to Give
    // amount = 6123456700909.123456789123456789 GUSD / 200.12345678 

    // expect amount 30598395607.571232843807983401100033706903271291774255... Give
    ...
    console.log(`give val is ${etherVal}`)

    // returns 30598395607571232843814242587

    // expected: 30598395607.571232843807983401100033706903271291774255... Give
    //  actual:   30598395607.571232843814242587 Give

    // accurate to 22 digits.  So with 99 billion give, it's accurate to 1 gwei. 
    ...
    // stake = 65032.123456789123456789 Give
    // S = 0.005555555888888888 Give per unit staked
    // S_0 = 0.003579246835792468 Give per uint staked
    // S - S_0 = 0.001976309053096420 
    // r = s * S - S0
    // r =  128.523574329736396343 Give
    ...
    /* stake = 5555565032.123456789123456789 Give
    S = 0.005555555888888888 Give per unit staked
    S_0 = 0.003579246835792468 Give per uint staked
    S - S_0 = 0.001976309053096420 
    r = s * S - S0
    r = 10979513.468051491046396343 Give
    */
    ...
    /* TODO: will L_GIVE, L_GUSD overflow if stored as 64.64? Possibly need to store as uint, divide by 1e18, then use
    the resulting 64.64  */
    ...
    /* 
    --- Using ABDK functions in Givety ---
