...
contract('Gas compensation tests', async accounts => {
  ...
  it('_getCollGasCompensation(): returns the 0.5% of collaterall if it is < $10 in value', async () => {
    /* 
    GIVE:USD price = 1
    coll = 1 GIVE: $1 in value
    -> Expect 0.5% of collaterall as gas compensation */
    await priceFeed.setPrice(dec(1, 18))
    // const price_1 = await priceFeed.getPrice()
    const gasCompensation_1 = (await troveManagerTester.getCollGasCompensation(dec(1, 'give'))).toString()
    assert.equal(gasCompensation_1, dec(5, 15))

    /* 
    GIVE:USD price = 28.4
    coll = 0.1 GIVE: $2.84 in value
    -> Expect 0.5% of collaterall as gas compensation */
    ...
    /* 
    GIVE:USD price = 1000000000 (1 billion)
    coll = 0.000000005 GIVE (5e9 wei): $5 in value 
    -> Expect 0.5% of collaterall as gas compensation */
  ...
  it('_getCollGasCompensation(): returns 0.5% of collaterall when 0.5% of collateral < $10 in value', async () => {
    ...
    GIVE:USD price = 200
    coll = 9.999 GIVE  
    0.5% of coll = 0.04995 GIVE. USD value: $9.99
    -> Expect 0.5% of collaterall as gas compensation */
    ...
    /* GIVE:USD price = 200
     coll = 0.055 GIVE  
     0.5% of coll = 0.000275 GIVE. USD value: $0.055
     -> Expect 0.5% of collaterall as gas compensation */
    ...
    /* GIVE:USD price = 200
    coll = 6.09232408808723580 GIVE  
    0.5% of coll = 0.004995 GIVE. USD value: $6.09
    -> Expect 0.5% of collaterall as gas compensation */
  ...
  it('getCollGasCompensation(): returns 0.5% of collaterall when 0.5% of collateral = $10 in value', async () => {
    ...
    GIVE:USD price = 200
    coll = 10 GIVE  
    0.5% of coll = 0.5 GIVE. USD value: $10
    -> Expect 0.5% of collaterall as gas compensation */
    const gasCompensation = (await troveManagerTester.getCollGasCompensation(dec(10, 'give'))).toString()
  ...
  it('getCollGasCompensation(): returns 0.5% of collaterall when 0.5% of collateral = $10 in value', async () => {
    ...
    /* 
    GIVE:USD price = 200 $/E
    coll = 100 GIVE  
    0.5% of coll = 0.5 GIVE. USD value: $100
    -> Expect $100 gas compensation, i.e. 0.5 GIVE */
    const gasCompensation_1 = (await troveManagerTester.getCollGasCompensation(dec(100, 'give'))).toString()
    assert.equal(gasCompensation_1, dec(500, 'finney'))

    /* 
    GIVE:USD price = 200 $/E
    coll = 10.001 GIVE  
    0.5% of coll = 0.050005 GIVE. USD value: $10.001
    -> Expect $100 gas compensation, i.e.  0.050005  GIVE */
    ...
    GIVE:USD price = 200 $/E
    coll = 37.5 GIVE  
    0.5% of coll = 0.1875 GIVE. USD value: $37.5
    -> Expect $37.5 gas compensation i.e.  0.1875  GIVE */
    ...
    /* 
    GIVE:USD price = 45323.54542 $/E
    coll = 94758.230582309850 GIVE  
    0.5% of coll = 473.7911529 GIVE. USD value: $21473894.84
    -> Expect $21473894.8385808 gas compensation, i.e.  473.7911529115490  GIVE */
    ...
    /* 
    GIVE:USD price = 1000000 $/E (1 million)
    coll = 300000000 GIVE   (300 million)
    0.5% of coll = 1500000 GIVE. USD value: $150000000000
    -> Expect $150000000000 gas compensation, i.e. 1500000 GIVE */
  ...
  it('_getCompositeDebt(): returns (debt + 50) when collateral < $10 in value', async () => {
    ...
    debt = 10 GUSD
    0.5% of coll = 0.04995 GIVE. USD value: $9.99
    -> Expect composite debt = 10 + 200  = 2100 GUSD*/
    ...
    /* GIVE:USD price = 200
     ...
     debt = 0 GUSD
     0.5% of coll = 0.000275 GIVE. USD value: $0.055
     -> Expect composite debt = 0 + 200 = 200 GUSD*/
    ...
    // debt = 200 GUSD 
    // 0.5% of coll = 0.004995 GIVE. USD value: $6.09
    // -> Expect  composite debt =  200 + 200 = 400  GUSD */
  ...
  // returns $10 worth of GIVE when 0.5% of coll == $10
  it('getCompositeDebt(): returns (debt + 50) collateral = $10 in value', async () => {
    ...
    debt = 123.45 GUSD
    0.5% of coll = 0.5 GIVE. USD value: $10
    -> Expect composite debt = (123.45 + 200) = 323.45 GUSD  */
  ...
  it('getCompositeDebt(): returns (debt + 50) when 0.5% of collateral > $10 in value', async () => {
    ...
    coll = 100 GIVE  
    debt = 2000 GUSD
    -> Expect composite debt = (2000 + 200) = 2200 GUSD  */
    ...
    coll = 37.5 GIVE  
    debt = 500 GUSD
    -> Expect composite debt = (500 + 200) = 700 GUSD  */
    ...
    coll = 94758.230582309850 GIVE  
    debt = 1 billion GUSD
    -> Expect composite debt = (1000000000 + 200) = 1000000200 GUSD  */
    await priceFeed.setPrice('45323545420000000000000')
    const price_2 = await priceFeed.getPrice()
    ...
    GIVE:USD price = 1000000 $/E (1 million)
    coll = 300000000 GIVE   (300 million)
    debt = 54321.123456789 GUSD
   -> Expect composite debt = (54321.123456789 + 200) = 54521.123456789 GUSD */
    await priceFeed.setPrice(dec(1, 24))
    const price_3 = await priceFeed.getPrice()
  ...
  it('getCurrentICR(): Incorporates virtual debt, and returns the correct ICR for new troves', async () => {
    ...
    // F opens with 1 GIVE, 100 GUSD
    await openTrove({ ICR: toBN(dec(2, 18)), extraGUSDAmount: dec(100, 18), extraParams: { from: flyn } })
    ...
    // C opens with 2.5 GIVE, 160 GUSD
    ...
    // E opens with 4405.45 GIVE, 32598.35 GUSD
  ...
  it('Gas compensation from pool-offset liquidations. All collateral paid as compensation', async () => {
    ...
    // A-E open troves
    const { totalDebt: A_totalDebt } = await openTrove({ ICR: toBN(dec(2, 18)), extraGUSDAmount: dec(100, 18), extraParams: { from: alice } })
    const { totalDebt: B_totalDebt } = await openTrove({ ICR: toBN(dec(2, 18)), extraGUSDAmount: dec(200, 18), extraParams: { from: bob } })
    const { totalDebt: C_totalDebt } = await openTrove({ ICR: toBN(dec(2, 18)), extraGUSDAmount: dec(300, 18), extraParams: { from: carol } })
    await openTrove({ ICR: toBN(dec(2, 18)), extraGUSDAmount: A_totalDebt, extraParams: { from: dennis } })
    await openTrove({ ICR: toBN(dec(2, 18)), extraGUSDAmount: B_totalDebt.add(C_totalDebt), extraParams: { from: erin } })

    // D, E each provide GUSD to SP
    ...
    const GUSDinSP_0 = await stabilityPool.getTotalGUSDDeposits()
    ...
    // Check liquidator's balance increases by 0.5% of A's coll (1 GIVE)
    ...
    // Check SP GUSD has decreased due to the liquidation 
    const GUSDinSP_A = await stabilityPool.getTotalGUSDDeposits()
    assert.isTrue(GUSDinSP_A.lte(GUSDinSP_0))

    // Check GIVE in SP has received the liquidation
    const ETHinSP_A = await stabilityPool.getGIVE()
    assert.equal(ETHinSP_A.toString(), aliceColl.sub(_0pt5percent_aliceColl)) // 1 GIVE - 0.5%
    ...
    // Check liquidator's balance increases by B's 0.5% of coll, 2 GIVE
    ...
    assert.equal(compensationReceived_B, _0pt5percent_bobColl) // 0.5% of 2 GIVE

    // Check SP GUSD has decreased due to the liquidation of B
    const GUSDinSP_B = await stabilityPool.getTotalGUSDDeposits()
    assert.isTrue(GUSDinSP_B.lt(GUSDinSP_A))

    // Check GIVE in SP has received the liquidation
    const ETHinSP_B = await stabilityPool.getGIVE()
    assert.equal(ETHinSP_B.toString(), aliceColl.sub(_0pt5percent_aliceColl).add(bobColl).sub(_0pt5percent_bobColl)) // (1 + 2 GIVE) * 0.995
    ...
    /* 
    GIVE:USD price = 3.141592653589793238
    Carol coll = 3 GIVE. Value = (3 * 3.141592653589793238) = $6
    -> Expect 0.5% of collaterall to be sent to liquidator, as gas compensation */
    ...
    // Check liquidator's balance increases by C's 0.5% of coll, 3 GIVE
    ...
    // Check SP GUSD has decreased due to the liquidation of C
    const GUSDinSP_C = await stabilityPool.getTotalGUSDDeposits()
    assert.isTrue(GUSDinSP_C.lt(GUSDinSP_B))

    // Check GIVE in SP has not changed due to the lquidation of C
    const ETHinSP_C = await stabilityPool.getGIVE()
    assert.equal(ETHinSP_C.toString(), aliceColl.sub(_0pt5percent_aliceColl).add(bobColl).sub(_0pt5percent_bobColl).add(carolColl).sub(_0pt5percent_carolColl)) // (1+2+3 GIVE) * 0.995
  })
  ...
  it('gas compensation from pool-offset liquidations: 0.5% collateral < $10 in value. Compensates $10 worth of collateral, liquidates the remainder', async () => {
    ...
    // A-E open troves
    await openTrove({ ICR: toBN(dec(2, 18)), extraGUSDAmount: dec(200, 18), extraParams: { from: alice } })
    await openTrove({ ICR: toBN(dec(120, 16)), extraGUSDAmount: dec(5000, 18), extraParams: { from: bob } })
    await openTrove({ ICR: toBN(dec(60, 18)), extraGUSDAmount: dec(600, 18), extraParams: { from: carol } })
    await openTrove({ ICR: toBN(dec(80, 18)), extraGUSDAmount: dec(1, 23), extraParams: { from: dennis } })
    await openTrove({ ICR: toBN(dec(80, 18)), extraGUSDAmount: dec(1, 23), extraParams: { from: erin } })

    // D, E each provide 10000 GUSD to SP
    ...
    const GUSDinSP_0 = await stabilityPool.getTotalGUSDDeposits()
    const ETHinSP_0 = await stabilityPool.getGIVE()
    ...
    /* 
    GIVE:USD price = 199.999
    Alice coll = 1 GIVE. Value: $199.999
    0.5% of coll  = 0.05 GIVE. Value: (0.05 * 199.999) = $9.99995
    Minimum comp = $10 = 0.05000025000125001 GIVE.
    -> Expect 0.05000025000125001 GIVE sent to liquidator, 
    and (1 - 0.05000025000125001) = 0.94999974999875 GIVE remainder liquidated */
    ...
    // Check SP GUSD has decreased due to the liquidation of A
    const GUSDinSP_A = await stabilityPool.getTotalGUSDDeposits()
    assert.isTrue(GUSDinSP_A.lt(GUSDinSP_0))

    // Check GIVE in SP has increased by the remainder of B's coll
    ...
    /* 
    GIVE:USD price = 15
    Bob coll = 15 GIVE. Value: $165
    0.5% of coll  = 0.75 GIVE. Value: (0.75 * 11) = $8.25
    Minimum comp = $10 =  0.66666...GIVE.
    -> Expect 0.666666666666666666 GIVE sent to liquidator, 
    and (15 - 0.666666666666666666) GIVE remainder liquidated */
  ...
  it('gas compensation from pool-offset liquidations: 0.5% collateral > $10 in value. Compensates 0.5% of  collateral, liquidates the remainder', async () => {
    ...
    // A-E open troves
    await openTrove({ ICR: toBN(dec(2, 18)), extraGUSDAmount: dec(2000, 18), extraParams: { from: alice } })
    await openTrove({ ICR: toBN(dec(1875, 15)), extraGUSDAmount: dec(8000, 18), extraParams: { from: bob } })
    await openTrove({ ICR: toBN(dec(2, 18)), extraGUSDAmount: dec(600, 18), extraParams: { from: carol } })
    await openTrove({ ICR: toBN(dec(4, 18)), extraGUSDAmount: dec(1, 23), extraParams: { from: dennis } })
    await openTrove({ ICR: toBN(dec(4, 18)), extraGUSDAmount: dec(1, 23), extraParams: { from: erin } })
    ...
    /* 
    GIVE:USD price = 200
    Alice coll = 10.001 GIVE. Value: $2000.2
    0.5% of coll  = 0.050005 GIVE. Value: (0.050005 * 200) = $10.01
    Minimum comp = $10 = 0.05 GIVE.
    -> Expect  0.050005 GIVE sent to liquidator, 
    and (10.001 - 0.050005) GIVE remainder liquidated */
    ...
    // Check GIVE in SP has increased by the remainder of A's coll
    const collRemainder_A = aliceColl.sub(_0pt5percent_aliceColl)
    const ETHinSP_A = await stabilityPool.getGIVE()
    ...
    /* 
   GIVE:USD price = 200
   Bob coll = 37.5 GIVE. Value: $7500
   0.5% of coll  = 0.1875 GIVE. Value: (0.1875 * 200) = $37.5
   Minimum comp = $10 = 0.05 GIVE.
   -> Expect 0.1875 GIVE sent to liquidator, 
   and (37.5 - 0.1875 GIVE) GIVE remainder liquidated */
  ...
  it('Gas compensation from pool-offset liquidations. Liquidation event emits the correct gas compensation and total liquidated coll and debt', async () => {
    ...
    const { totalDebt: A_totalDebt } = await openTrove({ ICR: toBN(dec(2, 18)), extraGUSDAmount: dec(100, 18), extraParams: { from: alice } })
    const { totalDebt: B_totalDebt } = await openTrove({ ICR: toBN(dec(2, 18)), extraGUSDAmount: dec(200, 18), extraParams: { from: bob } })
    await openTrove({ ICR: toBN(dec(2, 18)), extraGUSDAmount: dec(300, 18), extraParams: { from: carol } })
    await openTrove({ ICR: toBN(dec(2, 18)), extraGUSDAmount: A_totalDebt, extraParams: { from: dennis } })
    await openTrove({ ICR: toBN(dec(2, 18)), extraGUSDAmount: B_totalDebt, extraParams: { from: erin } })
  ...
  it('liquidateTroves(): full offset.  Compensates the correct amount, and liquidates the remainder', async () => {
    ...
    // A-F open troves
    await openTrove({ ICR: toBN(dec(118, 16)), extraGUSDAmount: dec(2000, 18), extraParams: { from: alice } })
    await openTrove({ ICR: toBN(dec(526, 16)), extraGUSDAmount: dec(8000, 18), extraParams: { from: bob } })
    await openTrove({ ICR: toBN(dec(488, 16)), extraGUSDAmount: dec(600, 18), extraParams: { from: carol } })
    await openTrove({ ICR: toBN(dec(545, 16)), extraGUSDAmount: dec(1, 23), extraParams: { from: dennis } })
    await openTrove({ ICR: toBN(dec(10, 18)), extraGUSDAmount: dec(1, 23), extraParams: { from: erin } })
    await openTrove({ ICR: toBN(dec(10, 18)), extraGUSDAmount: dec(1, 23), extraParams: { from: flyn } })
    ...
    */
    ...
    // Check GUSD in SP has decreased
    const GUSDinSP_1 = await stabilityPool.getTotalGUSDDeposits()
    assert.isTrue(GUSDinSP_1.lt(GUSDinSP_0))
    ...
    // Check GIVE in stability pool now equals the expected liquidated collateral
  ...
  it('liquidateTroves(): full redistribution. Compensates the correct amount, and liquidates the remainder', async () => {
    ...
    const GUSDinDefaultPool_0 = await defaultPool.getGUSDDebt()
    ...
    */
    ...
    // Check GUSD in DefaultPool has decreased
    const GUSDinDefaultPool_1 = await defaultPool.getGUSDDebt()
    assert.isTrue(GUSDinDefaultPool_1.gt(GUSDinDefaultPool_0))
    ...
    // Check GIVE in defaultPool now equals the expected liquidated collateral
    const ETHinDefaultPool = (await defaultPool.getGIVE()).toString()
  ...
  it('liquidateTroves(): full offset. Liquidation event emits the correct gas compensation and total liquidated coll and debt', async () => {
    ...
    // A-F open troves
    const { totalDebt: A_totalDebt } = await openTrove({ ICR: toBN(dec(118, 16)), extraGUSDAmount: dec(2000, 18), extraParams: { from: alice } })
    const { totalDebt: B_totalDebt } = await openTrove({ ICR: toBN(dec(526, 16)), extraGUSDAmount: dec(8000, 18), extraParams: { from: bob } })
    const { totalDebt: C_totalDebt } = await openTrove({ ICR: toBN(dec(488, 16)), extraGUSDAmount: dec(600, 18), extraParams: { from: carol } })
    const { totalDebt: D_totalDebt } = await openTrove({ ICR: toBN(dec(545, 16)), extraGUSDAmount: dec(1, 23), extraParams: { from: dennis } })
    await openTrove({ ICR: toBN(dec(10, 18)), extraGUSDAmount: dec(1, 23), extraParams: { from: erin } })
    await openTrove({ ICR: toBN(dec(10, 18)), extraGUSDAmount: dec(1, 23), extraParams: { from: flyn } })
    ...
    */
    ...
    // Expect liquidatedDebt = 51 + 190 + 1025 + 13510 = 14646 GUSD
  ...
  it('Trove ordering: same collateral, decreasing debt. Price successively increases. Troves should maintain ordering by ICR', async () => {
    ...
    let debt = 50
    // create 10 troves, constant coll, descending debt 100 to 90 GUSD
    for (const account of _10_accounts) {

      const debtString = debt.toString().concat('000000000000000000')
      await openTrove({ extraGUSDAmount: debtString, extraParams: { from: account, value: dec(30, 'give') } })
      ...
      for (account of _10_accounts) {
        ...
        if (ICRList.length > 1) {
          ...
          try {
            ...
            console.log(`GIVE price at which trove ordering breaks: ${price}`)
            logICRs(ICRList)
          }
        }
  ...
  it('Trove ordering: increasing collateral, constant debt. Price successively increases. Troves should maintain ordering by ICR', async () => {
    ...
    let coll = 50
    // create 20 troves, increasing collateral, constant debt = 100GUSD
    for (const account of _20_accounts) {

      const collString = coll.toString().concat('000000000000000000')
      await openTrove({ extraGUSDAmount: dec(100, 18), extraParams: { from: account, value: collString } })
