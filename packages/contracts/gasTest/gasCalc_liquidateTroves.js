...
contract('Gas cost tests', async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 give, withdraw 100 GUSD
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(10, 'give'), dec(100, 18))

    //1 accts open Trove with 1 give and withdraw 100 GUSD
    const _1_Defaulter = accounts.slice(1, 2)
    await th.openTrove_allAccounts(_1_Defaulter, contracts, dec(1, 'give'), dec(100, 18))
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, 'give'), dec(100, 18))
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts(_3_Defaulters, contracts, dec(1, 'give'), dec(100, 18))

    // Check all defaulters are active
    for (account of _3_Defaulters) { assert.isTrue(await sortedTroves.contains(account)) }

    // Account 500 opens with 1 give and withdraws 100 GUSD
    await borrowerOperations.openTrove(_100pct, dec(100, 18), accounts[500], ZERO_ADDRESS,{ from: accounts[500], value: dec(1, 'give') })
    assert.isTrue(await sortedTroves.contains(accounts[500]))
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts(_5_Defaulters, contracts, dec(1, 'give'), dec(100, 18))
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts(_10_Defaulters, contracts, dec(1, 'give'), dec(100, 18))
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts(_20_Defaulters, contracts, dec(1, 'give'), dec(100, 18))
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts(_30_Defaulters, contracts, dec(1, 'give'), dec(100, 18))
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts(_40_Defaulters, contracts, dec(1, 'give'), dec(100, 18))
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts(_45_Defaulters, contracts, dec(1, 'give'), dec(100, 18))
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(1000, 'give'), dec(10000, 18))

    //50 accts open Trove
    const _50_Defaulters = accounts.slice(1, 51)
    await th.openTrove_allAccounts(_50_Defaulters, contracts, dec(100, 'give'), dec(9500, 18))

    // Check all defaulters are active
    for (account of _50_Defaulters) { assert.isTrue(await sortedTroves.contains(account)) }

    // Account 500 opens
    await borrowerOperations.openTrove(_100pct, dec(10000, 18), accounts[500],ZERO_ADDRESS, { from: accounts[500], value: dec(100, 'give') })
    assert.isTrue(await sortedTroves.contains(accounts[500]))
  ...
  it("", async () => {
    ...
    //60 accts open Trove with 1 give and withdraw 100 GUSD
    const _60_Defaulters = accounts.slice(1, 61)
    await th.openTrove_allAccounts(_60_Defaulters, contracts, dec(1, 'give'), dec(100, 18))
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 15 give, withdraw 100 GUSD
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(15, 'give'), dec(100, 18))

    //65 accts open Trove with 1 give and withdraw 100 GUSD
    const _65_Defaulters = accounts.slice(1, 66)
    await th.openTrove_allAccounts(_65_Defaulters, contracts, dec(1, 'give'), dec(100, 18))
  ...
  it("", async () => {
    ...
    //50 accts open Trove with 1 give and withdraw 100 GUSD
    const _50_Defaulters = accounts.slice(1, 51)
    await th.openTrove_allAccounts(_50_Defaulters, contracts, dec(100, 'give'), dec(9500, 18))
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts(_55_Defaulters, contracts, dec(1, 'give'), dec(100, 18))
  ...
  it("", async () => {
    ...
    await borrowerOperations.openTrove(_100pct, dec(1, 27), accounts[999],ZERO_ADDRESS, { from: accounts[999], value: dec(1, 27) })
    await stabilityPool.provideToSP(dec(1, 27), ZERO_ADDRESS, { from: accounts[999] })
    assert.equal((await stabilityPool.getTotalGUSDDeposits()), dec(1, 27))
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 give, withdraw 100 GUSD
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(200, 'give'), dec(2000, 18))

    //10 accts open Trove with 1 give and withdraw 100 GUSD
    const _10_Defaulters = accounts.slice(1, 11)
    await th.openTrove_allAccounts(_10_Defaulters, contracts, dec(20, 'give'), dec(2000, 18))

    // Check all defaulters are active
    for (account of _10_Defaulters) { assert.isTrue(await sortedTroves.contains(account)) }

    // Account 500 opens with 1 give and withdraws 100 GUSD
    await borrowerOperations.openTrove(_100pct, dec(2000, 18), accounts[500],ZERO_ADDRESS, { from: accounts[500], value: dec(20, 'give') })
    assert.isTrue(await sortedTroves.contains(accounts[500]))
  ...
  it("", async () => {
    ...
    //50 accts open Trove with 1 give and withdraw 100 GUSD
    const _50_Defaulters = accounts.slice(1, 51)
    await th.openTrove_allAccounts(_50_Defaulters, contracts, dec(20, 'give'), dec(2000, 18))
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 give, withdraw 2000 GUSD
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(200, 'give'), dec(2000, 18))

    // Account 500 opens with 1 give and withdraws 2000 GUSD
    await borrowerOperations.openTrove(_100pct, dec(2000, 18), accounts[500],ZERO_ADDRESS, { from: accounts[500], value: dec(20, 'give') })
    assert.isTrue(await sortedTroves.contains(accounts[500]))
