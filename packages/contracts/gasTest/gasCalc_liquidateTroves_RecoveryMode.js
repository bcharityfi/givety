...
contract('Gas cost tests', async accounts => {
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 give, withdraw 900 GUSD
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(10, 'give'), dec(900, 18))
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }

    //1 accts open Trove with 1 give and withdraw 100 GUSD
    const _1_Defaulter = accounts.slice(1, 2)
    await th.openTrove_allAccounts(_1_Defaulter, contracts, dec(1, 'give'), dec(60, 18))

    // Check all defaulters are active
    for (account of _1_Defaulter) { assert.isTrue(await sortedTroves.contains(account)) }

    // Account 500 opens with 1 give and withdraws 100 GUSD
    await borrowerOperations.openTrove(_100pct, dec(60, 18), accounts[500], ZERO_ADDRESS, { from: accounts[500], value: dec(1, 'give') })
    ...
    // Check initial troves with starting 10E/90GUSD are still open
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }
  ...
  it("", async () => {
    ...
    //2 accts open Trove with 1 give and withdraw 100 GUSD
    const _2_Defaulters = accounts.slice(1, 3)
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, 'give'), dec(60, 18))
  ...
  it("", async () => {
    ...
    //3 accts open Trove with 1 give and withdraw 100 GUSD
    const _3_Defaulters = accounts.slice(1, 4)
    await th.openTrove_allAccounts(_3_Defaulters, contracts, dec(1, 'give'), dec(60, 18))
  ...
  it("", async () => {
    ...
    //5 accts open Trove with 1 give and withdraw 100 GUSD
    const _5_Defaulters = accounts.slice(1, 6)
    await th.openTrove_allAccounts(_5_Defaulters, contracts, dec(1, 'give'), dec(60, 18))
  ...
  it("", async () => {
    ...
    //10 accts open Trove with 1 give and withdraw 100 GUSD
    const _10_Defaulters = accounts.slice(1, 11)
    await th.openTrove_allAccounts(_10_Defaulters, contracts, dec(1, 'give'), dec(60, 18))
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 give, withdraw 90 GUSD
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(10, 'give'), dec(900, 18))
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }

    //20 accts open Trove with 1 give and withdraw 100 GUSD
    const _20_Defaulters = accounts.slice(1, 21)
    await th.openTrove_allAccounts(_20_Defaulters, contracts, dec(1, 'give'), dec(60, 18))
  ...
  it("", async () => {
    ...
    //30 accts open Trove with 1 give and withdraw 100 GUSD
    const _30_Defaulters = accounts.slice(1, 31)
    await th.openTrove_allAccounts(_30_Defaulters, contracts, dec(1, 'give'), dec(60, 18))
  ...
  it("", async () => {
    ...
    //40 accts open Trove with 1 give and withdraw 100 GUSD
    const _40_Defaulters = accounts.slice(1, 41)
    await th.openTrove_allAccounts(_40_Defaulters, contracts, dec(1, 'give'), dec(60, 18))
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(1000, 'give'), dec(90000, 18))
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }

    //45 accts open Trove
    const _45_Defaulters = accounts.slice(1, 46)
    await th.openTrove_allAccounts(_45_Defaulters, contracts, dec(100, 'give'), dec(9500, 18))

    // Check all defaulters are active
    for (account of _45_Defaulters) { assert.isTrue(await sortedTroves.contains(account)) }

    // Account 500 opens Trove
    await borrowerOperations.openTrove(_100pct, dec(9500, 18), accounts[500], ZERO_ADDRESS,{ from: accounts[500], value: dec(100, 'give') })
    assert.isTrue(await sortedTroves.contains(accounts[500]))
  ...
  it("", async () => {
    ...
    // Whale opens trove and fills SP with 1 billion GUSD
    ...
    // Check SP has 9e28 GUSD
    const GUSDinSP = (await stabilityPool.getTotalGUSDDeposits()).toString()
    assert.equal(GUSDinSP, dec(9, 28))

    //1 acct opens Trove with 1 give and withdraw 100 GUSD
    const _1_Defaulter = accounts.slice(1, 2)
    await th.openTrove_allAccounts(_1_Defaulter, contracts, dec(1, 'give'), dec(60, 18))
    ...
    // Check initial troves with starting 10E/90GUSD, and whale's trove, are still open
    for (account of accounts.slice(101, 111)) { assert.isTrue(await sortedTroves.contains(account)) }
    assert.isTrue(await sortedTroves.contains(whale))

    //Check GUSD in SP has decreased but is still > 0
    const GUSDinSP_After = await stabilityPool.getTotalGUSDDeposits()
    assert.isTrue(GUSDinSP_After.lt(web3.utils.toBN(dec(9, 28))))
    assert.isTrue(GUSDinSP_After.gt(web3.utils.toBN('0')))
  ...
  it("", async () => {
    ...
    //2 acct opens Trove with 1 give and withdraw 100 GUSD
    const _2_Defaulters = accounts.slice(1, 3)
    await th.openTrove_allAccounts(_2_Defaulters, contracts, dec(1, 'give'), dec(60, 18))
  ...
  it("", async () => {
    ...
    //45 accts open Trove with 1 give and withdraw 100 GUSD
    const _45_Defaulters = accounts.slice(1, 46)
    await th.openTrove_allAccounts(_45_Defaulters, contracts, dec(100, 'give'), dec(9500, 18))
  ...
  it("", async () => {
    ...
    // Account 500 opens with 1 give and withdraws 110 GUSD
    await borrowerOperations.openTrove(_100pct, dec(110, 18), accounts[500],ZERO_ADDRESS, { from: accounts[500], value: dec(1, 'give') })
    assert.isTrue(await sortedTroves.contains(accounts[500]))
  ...
  it("", async () => {
    ...
    // Account 500 opens
    await borrowerOperations.openTrove(_100pct, dec(11000, 18), accounts[500],ZERO_ADDRESS, { from: accounts[500], value: dec(100, 'give') })
    assert.isTrue(await sortedTroves.contains(accounts[500]))
  ...
  it("", async () => {
    ...
    // 10 accts each open Trove with 10 give, withdraws GUSD

    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(1000, 'give'), dec(13000, 18))

    // Account 500 opens with 1 give and withdraws GUSD
    await borrowerOperations.openTrove(_100pct, dec(13000, 18), accounts[500],ZERO_ADDRESS, { from: accounts[500], value: dec(100, 'give') })

    const _10_defaulters = accounts.slice(1, 11)
    // --- Accounts to be liquidated in the test tx ---
    await th.openTrove_allAccounts(_10_defaulters, contracts, dec(100, 'give'), dec(13000, 18))
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(100, 'give'), dec(13000, 18))

    // Account 500 opens with 1 give and withdraws 180 GUSD
    await borrowerOperations.openTrove(_100pct, dec(13000, 18), accounts[500], ZERO_ADDRESS,{ from: accounts[500], value: dec(100, 'give') })


    // --- Accounts to be liquidated in the test tx ---
    const _40_defaulters = accounts.slice(1, 41)
    await th.openTrove_allAccounts(_40_defaulters, contracts, dec(100, 'give'), dec(13000, 18))
  ...
  it("", async () => {
    ...
    // --- Accounts to be liquidated in the test tx ---
    const _45_defaulters = accounts.slice(1, 46)
    await th.openTrove_allAccounts(_45_defaulters, contracts, dec(100, 'give'), dec(13000, 18))
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts(_50_defaulters, contracts, dec(100, 'give'), dec(13000, 18))
  ...
  it("", async () => {
    ...
    await th.openTrove_allAccounts(accounts.slice(101, 111), contracts, dec(100, 'give'), dec(10000, 18))
