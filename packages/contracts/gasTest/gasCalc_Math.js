...
/* Script that logs gas costs for Givety math functions. */
contract('Gas costs for math functions', async accounts => {
  ...
  before(async () => {
    ...
    mathTester = await GivetyMathTester.new()
    GivetyMathTester.setAsDeployed(mathTester)
  })
  ...
  beforeEach(async () => {
    ...
    gtStaking = GVTYContracts.gtStaking
