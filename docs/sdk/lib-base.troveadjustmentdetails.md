...
[Home](./index.md) &gt; [givety-lib-base](./lib-base.md) &gt; [TroveAdjustmentDetails](./lib-base.troveadjustmentdetails.md)

## TroveAdjustmentDetails interface

Details of an [adjustTrove()](./lib-base.transactablegivety.adjusttrove.md) transaction.
...
|  --- | --- | --- |
|  [fee](./lib-base.troveadjustmentdetails.fee.md) | [Decimal](./lib-base.decimal.md) | Amount of GUSD added to the Trove's debt as borrowing fee. |
