...
[Home](./index.md) &gt; [@givety/lib-ethers](./lib-ethers.md) &gt; [SendableEthersGivety](./lib-ethers.sendableethersgivety.md) &gt; [stakeGVTY](./lib-ethers.sendableethersgivety.stakegvty.md)

## SendableEthersGivety.stakeGVTY() method
...
```typescript
stakeGVTY(amount: Decimalish, overrides?: EthersTransactionOverrides): Promise<SentEthersGivetyTransaction<void>>;
```
