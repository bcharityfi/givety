...
[Home](./index.md) &gt; [@givety/lib-ethers](./lib-ethers.md) &gt; [PopulatableEthersGivety](./lib-ethers.populatableethersgivety.md) &gt; [adjustTrove](./lib-ethers.populatableethersgivety.adjusttrove.md)

## PopulatableEthersGivety.adjustTrove() method
...
```typescript
adjustTrove(params: TroveAdjustmentParams<Decimalish>, maxBorrowingRateOrOptionalParams?: Decimalish | BorrowingOperationOptionalParams, overrides?: EthersTransactionOverrides): Promise<PopulatedEthersGivetyTransaction<TroveAdjustmentDetails>>;
```
