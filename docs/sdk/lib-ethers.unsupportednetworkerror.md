...
[Home](./index.md) &gt; [@givety/lib-ethers](./lib-ethers.md) &gt; [UnsupportedNetworkError](./lib-ethers.unsupportednetworkerror.md)
...
Thrown by [ReadableEthersGivety.connect()](./lib-ethers.readableethersgivety.connect_1.md) and [EthersGivety.connect()](./lib-ethers.ethersgivety.connect_1.md)<!-- -->.
