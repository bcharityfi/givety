...
[Home](./index.md) &gt; [givety-lib-base](./lib-base.md) &gt; [Decimal](./lib-base.decimal.md)
...
Used by Givety libraries to precisely represent native currency (e.g. Give), GUSD and GVTY amounts, as well as derived metrics like collateral ratios.
