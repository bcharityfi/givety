...
[Home](./index.md) &gt; [@givety/lib-ethers](./lib-ethers.md) &gt; [EthersTransactionOverrides](./lib-ethers.etherstransactionoverrides.md)

## EthersTransactionOverrides interface

Optional parameters taken by [EthersGivety](./lib-ethers.ethersgivety.md) transaction functions.
