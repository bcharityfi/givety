...
[Home](./index.md) &gt; [givety-lib-base](./lib-base.md) &gt; [PopulatableGivety](./lib-base.populatablegivety.md) &gt; [repayGUSD](./lib-base.populatablegivety.repaygusd.md)

## PopulatableGivety.repayGUSD() method
...
```typescript
repayGUSD(amount: Decimalish): Promise<PopulatedGivetyTransaction<P, SentGivetyTransaction<S, GivetyReceipt<R, TroveAdjustmentDetails>>>>;
```
