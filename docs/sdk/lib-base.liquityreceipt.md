...
[Home](./index.md) &gt; [givety-lib-base](./lib-base.md) &gt; [GivetyReceipt](./lib-base.givetyreceipt.md)
...
```typescript
export declare type GivetyReceipt<R = unknown, D = unknown> = PendingReceipt | MinedReceipt<R, D>;
```
